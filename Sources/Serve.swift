...
private let mcpTools: [[String: Any]] = [
    ...
    [
        "name": "vault_read",
        "description": "Read a file from the Obsidian vault (The Brass). Path is relative to vault root.",
        "inputSchema": [
            "type": "object",
            "properties": [
    ...
    [
        "name": "vault_write",
        "description": "Write or update a file in the Obsidian vault (The Brass). Path is relative to vault root.",
        "inputSchema": [
            "type": "object",
            "properties": [
