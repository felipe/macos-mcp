...
```bash
# iMessage
macos-mcp messages check --phone 3034594642 --after-rowid 4800
macos-mcp messages read --phone 3034594642 --limit 10
macos-mcp send message 3034594642 "Hello!"
macos-mcp send file 3034594642 /path/to/image.png
...
# iCloud file sync
macos-mcp icloud sync --source "The Brass" --cache /tmp/cache --files "stack.md" -- ./script.sh
